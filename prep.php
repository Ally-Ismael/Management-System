...
<html>
<head>
    <title>Private Cars Report</title>
    <!-- Your CSS styling -->
	<style>
	body {
...
<body>
    <div class="container">
        <h2>In and Out Private Cars Report</h2>
        <table>
            <tr>
                <th>Id</th>
            ...
            if (isset($db) && $db) {
                ...
                $sql = "SELECT ls.id, ls.registration_number, l.owner, l.department, ls.scanned_at, ls.action 
                        FROM ptransactions ls 
                        LEFT JOIN pcars l ON ls.registration_number = l.registration_number";
                $result = $db->query($sql);
                ...
                if ($result) {
                    if ($result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='6'>No scanned private cars found.</td></tr>";
                    }
                } else {
