...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE laptops SET serial_number='$serial_number', model='$model', owner='$owner', department='$department' WHERE id=$id";
...
<head>
    ...
    <title>Edit Company Laptop</title>
    <style>
        body {
